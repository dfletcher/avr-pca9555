...
#define DEMO_LED_PORT  PORTA
#define DEMO_LED_DDR   DDRA
#define DEMO_LED_PIN   PA3
#define DEMO_PCMSK     PCMSK0
#define DEMO_PCINT     PCINT0
#define DEMO_GIMSK     GIMSK
#define DEMO_PCIE      PCIE0
#define DEMO_VECT      PCINT0_vect
